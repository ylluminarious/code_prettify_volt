...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'code-prettify-volt.com'
  config.app_name = 'Code_prettify_volt'
  config.mailer.from = 'Code_prettify_volt <no-reply@code-prettify-volt.com>'
  ...
  #
  config.app_secret = 'fkvx8WoP7U7oHhD8Gna_JiYaGDrb_aR4S000JKx_riSAXKn7kVV55q3uemROkY8T_0o'
